    ...
    de: {
        translation: {
            ...
            "datenschutz": {
                ...
                "p_glance": "Die folgenden Hinweise geben einen einfachen Überblick darüber, was mit Ihren personenbezogenen Daten passiert, wenn Sie diese Website besuchen. Personenbezogene Daten sind alle Daten, mit denen Sie persönlich identifiziert werden können. Ausführliche Informationen zum Thema Datenschutz entnehmen Sie unserer unter diesem Text aufgeführten Datenschutzerklärung.",
                ...
                "p_responsible": "Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber. Dessen Kontaktdaten können Sie dem Abschnitt „Hinweis zur Verantwortlichen Stelle“ in dieser Datenschutzerklärung entnehmen.",
                ...
                "p_rights": "Sie haben jederzeit das Recht, unentgeltlich Auskunft über Herkunft, Empfänger und Zweck Ihrer gespeicherten personenbezogenen Daten zu erhalten. Sie haben außerdem ein Recht, die Berichtigung oder Löschung dieser Daten zu verlangen. Wenn Sie eine Einwilligung zur Datenverarbeitung erteilt haben, können Sie diese Einwilligung jederzeit für die Zukunft widerrufen. Außerdem haben Sie das Recht, unter bestimmten Umständen die Einschränkung der Verarbeitung Ihrer personenbezogenen Daten zu verlangen. Des Weiteren steht Ihnen ein Beschwerderecht bei der zuständigen Aufsichtsbehörde zu.",
                "hosting": "3. Hosting",
                "hosting_railway": "Wir hosten unsere Website bei Railway. Anbieter ist die Railway Corp. Wenn Sie unsere Website besuchen, werden verschiedene Logfiles inkl. Ihrer IP-Adressen erfasst.",
                "encryption": "4. SSL- bzw. TLS-Verschlüsselung",
                "p_encryption": "Diese Seite nutzt aus Sicherheitsgründen und zum Schutz der Übertragung vertraulicher Inhalte, wie zum Beispiel Bestellungen oder Anfragen, die Sie an uns als Seitenbetreiber senden, eine SSL- bzw. TLS-Verschlüsselung. Eine verschlüsselte Verbindung erkennen Sie daran, dass die Adresszeile des Browsers von „http://“ auf „https://“ wechselt und an dem Schloss-Symbol in Ihrer Browserzeile.",
                "cookies": "5. Cookies",
                "p_cookies": "Unsere Internetseiten verwenden so genannte „Cookies“. Cookies sind kleine Textdateien und richten auf Ihrem Endgerät keinen Schaden an. Sie werden entweder vorübergehend für die Dauer einer Sitzung (Session-Cookies) oder dauerhaft (permanente Cookies) auf Ihrem Endgerät gespeichert. Cookies dienen dazu, unser Angebot nutzerfreundlicher, effektiver und sicherer zu machen.",
                "analysis": "6. Analyse-Tools und Tools von Drittanbietern",
                "p_analysis": "Wir nutzen die Noble Atlas Sync API zur Darstellung von Sedcards. Hierbei werden technisch notwendige Daten an den Anbieter übertragen, um die Profile anzuzeigen. Weitere Informationen finden Sie in der Datenschutzerklärung des Anbieters.",
                "template_notice": "Hinweis: Diese Datenschutzerklärung dient der Information. Für eine rechtssichere Beratung wenden Sie sich bitte an einen Fachanwalt."
            },
            "cookie": {
                "text": "Wir verwenden Cookies, um die Nutzererfahrung zu verbessern und die Funktionalität unserer Website zu gewährleisten.",
                "privacy_link": "Details finden Sie in unserer",
    ...
    en: {
        translation: {
            ...
            "datenschutz": {
                ...
                "p_rights": "You have the right at any time to receive information about the origin, recipient and purpose of your stored personal data free of charge. You also have a right to request the correction or deletion of this data. If you have given your consent to data processing, you can revoke this consent at any time for the future. You also have the right to request that the processing of your personal data be restricted under certain circumstances. Furthermore, you have a right of appeal to the competent supervisory authority.",
                "hosting": "3. Hosting",
                "hosting_railway": "We host our website at Railway. The provider is Railway Corp. When you visit our website, various log files including your IP addresses are recorded.",
                "encryption": "4. SSL or TLS Encryption",
                "p_encryption": "For security reasons and to protect the transmission of confidential content, such as orders or requests that you send to us as the site operator, this site uses SSL or TLS encryption. You can recognize an encrypted connection by the fact that the address line of the browser changes from \"http://\" to \"https://\" and by the lock symbol in your browser line.",
                "cookies": "5. Cookies",
                "p_cookies": "Our internet pages use so-called \"cookies\". Cookies are small text files and do not cause any damage to your end device. They are stored either temporarily for the duration of a session (session cookies) or permanently (permanent cookies) on your end device. Cookies serve to make our offer more user-friendly, effective and secure.",
                "analysis": "6. Analysis Tools and Third-Party Tools",
                "p_analysis": "We use the Noble Atlas Sync API to display sedcards. In this process, technically necessary data is transferred to the provider to display the profiles. Further information can be found in the provider's privacy policy.",
                "template_notice": "Note: This privacy policy is for information purposes. For legally binding advice, please contact a specialist lawyer."
            },
            "cookie": {
                "text": "We use cookies to improve the user experience and ensure the functionality of our website.",
                "privacy_link": "Details can be found in our",
                "accept": "Accept all",
